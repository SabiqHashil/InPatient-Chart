  ...
  return (
    <div className="hidden print:block mt-auto">
      ...
      <div className="flex w-full h-3 mb-2">
        <div className="bg-[#56b72a] flex-grow"></div> {/* Green bar */}
        <div className="bg-[#56b72a] w-12 skew-x-[30deg] -ml-2 z-10"></div>{" "}
        {/* Slant */}
      ...
      <div className="flex justify-between items-end px-2 pb-2 text-[#005288] font-bold">
        ...
        <div className="flex-1 text-center text-[9px] leading-tight flex flex-col items-center">
          <p>Email: info@mypetsa.com</p>
          <p>Web : www.mypetsa.com</p>
        </div>
      ...
      {isLastPage && (
        <div className="text-center text-[7px] text-gray-400 mt-1 italic border-t border-gray-100">
