...
const TreatmentPlanTable = ({ rows, dateCols, onUpdate, onRemove, onAdd }) => {
  return (
    <section className="mb-6 print:mb-4">
      {/* Header aligned with AdmissionForm logic (2/3 columns) */}
      <div className="grid grid-cols-2 lg:grid-cols-3 items-center mb-3 gap-3 print:flex print:justify-between print:mb-1">
        ...
        {/* Spacer for 3-column layout on Desktop */}
      ...
      <div className="overflow-x-auto -mx-4 sm:mx-0 shadow-sm rounded-lg border border-blue-200 sm:border-0">
        <table className="min-w-[750px] w-full border-collapse border-2 border-blue-300 text-sm print:text-[10px] print:border print:border-gray-800">
          <thead>
            <tr className="bg-blue-600 text-white print:bg-gray-100 print:text-gray-900">
              <th className="border-2 border-blue-300 print:border print:border-gray-800 p-2 sm:p-3 text-left font-semibold w-48 sm:w-56">
                Medicine / Dose
              </th>
              {dateCols.map((date, i) => (
                <th
              ...
              <th className="border-2 border-blue-300 p-2 w-20 print:hidden font-semibold">
                Actions
              </th>
            </tr>
          </thead>
              ...
              >
                ...
                <td className="border-2 border-blue-300 print:border print:border-gray-800 p-2 sm:p-3">
                  <input
                    ...
                    className="w-full bg-transparent outline-none font-bold text-blue-900 placeholder-blue-300 text-xs sm:text-sm mb-0.5"
                ...
                {dateCols.map((_, i) => (
                  <td
                    key={i}
                    className="border-2 border-blue-300 print:border print:border-gray-800 p-0 h-12 sm:h-14 relative"
                  >
                    {row.type === "Twice" && (
                ...
                <td className="border-2 border-blue-300 p-1 text-center bg-blue-50 print:hidden">
                  <div className="flex flex-col gap-1.5 items-center">
                    <select
                      ...
                      className="text-[10px] border border-blue-300 rounded bg-white px-1 h-6 outline-none focus:ring-1 focus:ring-blue-500 font-semibold text-blue-700"
                    >
      ...
      <div className="mt-2 text-[10px] text-gray-400 sm:hidden italic flex items-center gap-1 justify-center">
        <svg
          className="w-3 h-3"
          fill="none"
          stroke="currentColor"
        ...
        Swipe left/right to view all treatment dates
      </div>
    </section>
  );
};
