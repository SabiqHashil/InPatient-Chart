      ...
      <table className="w-full border-collapse border-2 border-blue-300 text-sm print:text-xs print:border print:border-gray-800 rounded-lg overflow-hidden">
        <thead>
          <tr className="bg-blue-600 text-white print:bg-gray-100 print:text-gray-900">
            <th className="border-2 border-blue-300 print:border print:border-gray-800 p-3 text-left font-semibold print:p-1">
              Diet's
            </th>
            {dateCols.map((date, i) => (
              <th
            ...
            >
              ...
              <td className="border-2 border-blue-300 print:border print:border-gray-800 p-3 print:p-1">
                <input
                  ...
                  className="w-full bg-transparent outline-none font-medium placeholder-gray-400 text-sm print:text-xs"
              ...
              {dateCols.map((_, i) => (
                <td
                  key={i}
                  className="border-2 border-blue-300 print:border print:border-gray-800 p-0 h-10 print:h-8 relative"
                >
                  {/* Once/Twice Logic */}
                  {row.type === "Twice" ? (
